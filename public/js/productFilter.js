window.addEventListener('load', () => {
    ...
    let inputsTalle = document.querySelectorAll('input.talle');
    let aplicarFiltro = document.querySelector('.aplicar-filtro');
    ...
    aplicarFiltro.addEventListener('click', () => {
        ...
        for(let i=0; i<inputsTalle.length; i++) {
            if(inputsTalle[i].checked) {
                query += "talle=" + inputsTalle[i].value + "&"
            }
        }
