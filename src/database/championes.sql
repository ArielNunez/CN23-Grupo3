...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-01-2021 a las 15:09:24
...
INSERT INTO `productos` (`id`, `producto`, `descripcion`, `id_categoria`, `id_marca`, `precio`, `descuento`, `created_at`, `updated_at`, `estado`) VALUES
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `categoria` FOREIGN KEY (`categoria`) REFERENCES `categorias_usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
